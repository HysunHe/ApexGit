...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1500924855982975)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1501260702982975)
,p_plug_template_id=>wwv_flow_imp.id(1500924855982975)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1501520807982975)
,p_plug_template_id=>wwv_flow_imp.id(1500924855982975)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1501862118982975)
,p_plug_template_id=>wwv_flow_imp.id(1500924855982975)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1502172144982975)
,p_plug_template_id=>wwv_flow_imp.id(1500924855982975)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1502423333982976)
,p_plug_template_id=>wwv_flow_imp.id(1500924855982975)
,p_name=>'Sub Regions'
