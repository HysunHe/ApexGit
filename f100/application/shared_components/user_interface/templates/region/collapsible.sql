...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1461908556982960)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1462273554982960)
,p_plug_template_id=>wwv_flow_imp.id(1461908556982960)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1462563049982960)
,p_plug_template_id=>wwv_flow_imp.id(1461908556982960)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1462896012982960)
,p_plug_template_id=>wwv_flow_imp.id(1461908556982960)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1463190832982961)
,p_plug_template_id=>wwv_flow_imp.id(1461908556982960)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1463490302982961)
,p_plug_template_id=>wwv_flow_imp.id(1461908556982960)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1463762937982961)
,p_plug_template_id=>wwv_flow_imp.id(1461908556982960)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1464067901982961)
,p_plug_template_id=>wwv_flow_imp.id(1461908556982960)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1464305295982961)
,p_plug_template_id=>wwv_flow_imp.id(1461908556982960)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1464656553982961)
,p_plug_template_id=>wwv_flow_imp.id(1461908556982960)
,p_name=>'Sub Regions'
