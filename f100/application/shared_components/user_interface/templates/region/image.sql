...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1478843591982967)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1479198568982967)
,p_plug_template_id=>wwv_flow_imp.id(1478843591982967)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1479491587982967)
,p_plug_template_id=>wwv_flow_imp.id(1478843591982967)
,p_name=>'Sub Regions'
