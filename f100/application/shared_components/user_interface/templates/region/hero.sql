...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1475692775982965)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1475941629982966)
,p_plug_template_id=>wwv_flow_imp.id(1475692775982965)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1476273339982966)
,p_plug_template_id=>wwv_flow_imp.id(1475692775982965)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1476558667982966)
,p_plug_template_id=>wwv_flow_imp.id(1475692775982965)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1476852729982966)
,p_plug_template_id=>wwv_flow_imp.id(1475692775982965)
,p_name=>'Sub Regions'
