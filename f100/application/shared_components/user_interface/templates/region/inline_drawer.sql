...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1488878803982971)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1489179603982971)
,p_plug_template_id=>wwv_flow_imp.id(1488878803982971)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1489400043982971)
,p_plug_template_id=>wwv_flow_imp.id(1488878803982971)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1489758993982971)
,p_plug_template_id=>wwv_flow_imp.id(1488878803982971)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1490069780982972)
,p_plug_template_id=>wwv_flow_imp.id(1488878803982971)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1490388779982972)
,p_plug_template_id=>wwv_flow_imp.id(1488878803982971)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1490623162982972)
,p_plug_template_id=>wwv_flow_imp.id(1488878803982971)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1490956997982972)
,p_plug_template_id=>wwv_flow_imp.id(1488878803982971)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1491215860982972)
,p_plug_template_id=>wwv_flow_imp.id(1488878803982971)
,p_name=>'Sub Regions'
