...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1450105968982956)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1450462286982956)
,p_plug_template_id=>wwv_flow_imp.id(1450105968982956)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1450704594982956)
,p_plug_template_id=>wwv_flow_imp.id(1450105968982956)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1451045125982956)
,p_plug_template_id=>wwv_flow_imp.id(1450105968982956)
,p_name=>'Sub Regions'
