...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1719865324983314)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1719910741983314)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1722749836983316)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1719910741983314)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1723141948983316)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1720928847983315)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1722362876983316)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1723428323983316)
,p_name=>'P10042_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1719865324983314)
,p_item_source_plug_id=>wwv_flow_imp.id(1719865324983314)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1723877859983316)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1724219399983317)
...
,p_field_template=>wwv_flow_imp.id(1575109068983004)
,p_is_persistent=>'N'
,p_lov_display_extra=>'NO'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1724685541983317)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1725904440983322)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1721095544983315)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1720928847983315)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1721725853983315)
,p_event_id=>wwv_flow_imp.id(1721095544983315)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1726290284983322)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(1719865324983314)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Initialize form Manage User Access'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1726632363983322)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1727044750983323)
